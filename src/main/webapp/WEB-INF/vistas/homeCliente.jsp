...
<!-- Content page-->
	<section class="full-box dashboard-contentPage">
		...
		<div class="full-box text-center" style="padding: 30px 10px;">
		  <h2><span>Usa el mapa Para conocer los combos mas cercanos</span></h2>
		</div>
...
<div id="map_canvas" style="width: auto; height: 500px;">
			...
			<form method="get" action="codigoLocalizacion" >
 
    <input name="lat" id="txtLat" type="hidden" style="color:red" value="-34.686078060293006" />
  
    <input  name="lon" id="txtLng" type="hidden" style="color:red" value="-58.61402310230241" /><br />
   
      <button class="btn btn-primary" type="submit">Buscar</button>
			</form>
	       		
		<div class="full-box text-center" style="padding: 30px 10px;">
		  <h2><span>Combos Cercanos</span></h2>
		</div>
			</div>
			<div class="full-box text-center" style="padding: 30px 10px;">
    ...
    <c:if test="${ empty mensajeActivo}">
		...
		<div class="full-box text-center" style="padding: 30px 10px;">
	        ...
	        <c:if test="${not empty combos3}">
				<div class="row">
					<c:forEach items="${combos3}" var="combo">
                                    ...
                                    <c:if test="${empty combo.imagen}">
			      					...
			      					<div class="caption">
			        					<h3>${combo.nombre}</h3>
			       						...
			       						<p>Distancia al Vendedor: ${combo.distancia}</p>
